...
public class ErrorMessageFactory {
	...
	private ErrorMessageFactory() {
		errorMessages.put(ErrorType.GenericSystemError, new SystemErrorMessage("A generic error type $errorCode occured. Please refer to :\n",
				"http://google.com/q="));
		errorMessages.put(ErrorType.PageNotFoundError, new SystemErrorMessage("Page not found. An error type $errorCode occured. Please refer to :\n",
				"http://google.com/q="));
	}
